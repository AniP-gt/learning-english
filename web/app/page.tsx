...
export default function HomePage() {
  ...
  const stepPanels = [
    ...
    <ListeningStep readingOutput={learning.readingOutput} listeningSupported={learning.listeningSupported} voices={learning.voices} selectedVoice={learning.selectedVoice} onVoiceChange={learning.setSelectedVoice} speechRate={learning.speechRate} onSpeechRateChange={learning.setSpeechRate} handleSpeak={learning.handleSpeak} handleStop={learning.handleStop} isSpeaking={learning.isSpeaking} key="listening" />,
