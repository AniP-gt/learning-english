...
export default function HomePage() {
  ...
  const stepPanels = [
    ...
    <WordsStep wordsTable={learning.wordsTable} wordsCount={learning.wordsCount} handleRegenerateWords={learning.handleRegenerateWords} key="words" />,
    ...
    <ListeningStep readingOutput={learning.readingOutput} listeningSupported={learning.listeningSupported} voices={learning.voices} selectedVoice={learning.selectedVoice} onVoiceChange={learning.setSelectedVoice} speechRate={learning.speechRate} onSpeechRateChange={learning.setSpeechRate} handleSpeak={learning.handleSpeak} isSpeaking={learning.isSpeaking} key="listening" />,
